...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="cd-root">
      <aside className="cd-sidebar"><div className="cd-brand"><i aria-hidden="true" />Inzu<span>Hub</span></div><nav className="cd-nav" aria-label="Admin navigation"><a className="cd-nav-item active" href="#overview">⌂ Overview</a><a className="cd-nav-item" href="#users">Users</a><Link className="cd-nav-item" href="/">Public site</Link></nav><button className="cd-signout" type="button" onClick={() => signOut({ callbackUrl: "/" })}>↩ Sign out</button></aside>
